...
int main()
{
    ...
    /*  Initialize both  */
    rle_block_new(&encoder, 20000, 95);
    encoder->rle_0 = 2, encoder->rle_1 = 2;
    rle_decoder_new(&decoder, 64, 800, encoder->res_buf, encoder->rle_0, encoder->rle_1, 8, 16);
    // Malloc data
    uint8_t *test_data = &ascii_32x64[0];
    // Configure encoder
    compress_conf_init(encoder);
    encoder->conf->each_size = 16;
    // Load the data array
    ...
    */
    ...
    uint8_t is_first_time = 1, new_line = 0;
    ...
    for (int i = 0; i < 95; i++)
    {
        ...
        {
            new_line = 0;
            decoder->x_start = 0, decoder->y_start += 16;
        }
        else {
            new_line ++;
            decoder->x_start += 8;
